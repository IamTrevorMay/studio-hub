...
import { FileText, Type, Plus, Search } from 'lucide-react'
...
interface CommandItem {
  ...
  label: string
  shortcut?: string
  category: 'document' | 'format' | 'insert' | 'app'
  action: () => void
}
...
export default function CommandPalette({
  ...
  const commands = useMemo<CommandItem[]>(() => {
    ...
    // App commands
    cmds.push(
      { id: 'app-new', label: 'New Document', category: 'app', action: () => { createDocument(); onClose() } },
    ...
    return cmds
  }, [documents, editor, setActiveDocument, createDocument, onClose, onOpenSettings, onToggleFindReplace, onToggleComments, toggleFocusMode])
  ...
  const grouped = useMemo(() => {
    ...
    const catOrder = ['document', 'format', 'insert', 'app']
