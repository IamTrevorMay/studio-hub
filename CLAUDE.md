...
- **Tools:** select (move / marquee / resize handles), pan, pen, eraser, line, arrow, rectangle, ellipse, text, fill. Fill paints a shape's interior, or the board background when you click empty space. Keyboard: V/H/P/E/L/A/R/O/T/F, ⌘Z / ⇧⌘Z, ⌘A, ⌘D duplicate, ⌘C / ⌘X / ⌘V, Delete, Escape, Space-drag to pan, ⌘+scroll to zoom.
