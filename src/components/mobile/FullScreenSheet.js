...
//   children
export default function FullScreenSheet({ open, onClose, title, rightAction, children }) {
  useEffect(() => {
  ...
  return (
    <div style={styles.root}>
      <div style={{ ...styles.header, paddingTop: `calc(${mobileTokens.space.md}px + ${mobileTokens.safeTop})` }}>
        <button onClick={onClose} style={{ ...mobileTapButton, ...styles.backBtn }} aria-label="Back">
