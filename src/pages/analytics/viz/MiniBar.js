...
export default function MiniBar({
  ...
  return (
    <div style={{
      ...
      background: showTrack ? 'rgba(255,255,255,0.05)' : 'transparent',
    }}>
      ...
      {label != null && (
        <span style={{ position: 'absolute', right: 8, top: '50%', transform: 'translateY(-50%)', fontSize: 11, fontWeight: 700, color: '#e7ebf2', fontVariantNumeric: 'tabular-nums' }}>
          {label}
        </span>
      )}
    </div>
