...
export default function TikTokCSVUpload({ profile, accounts }) {
  ...
  if (!tiktokAccount) return <p style={{ color: 'rgba(255,255,255,0.42)', fontSize: '13px', margin: 0 }}>No TikTok account found.</p>;
    ...
    <div>
      ...
      <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
          <label style={{ fontSize: '11px', color: 'rgba(255,255,255,0.42)', fontWeight: 600 }}>Year</label>
