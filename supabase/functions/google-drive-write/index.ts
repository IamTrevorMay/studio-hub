...
// Root folder ID for Write — users cannot navigate above this.
// Designated writing folder in Trevor's My Drive.
const ROOT_ID = "19YD2tNTJcxwbCWsSIYImD3xTNS8hGPtU";
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (req.method === "GET") {
      ...
      // Drive ids are [A-Za-z0-9_-]; reject anything else so a quote can't break
      // out of the `q` string below.
